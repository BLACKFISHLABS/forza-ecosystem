...
import io.github.blackfishlabs.forza.helper.RealmAutoIncrement;
...
public class CustomerEntity implements RealmModel {
    ...
    public static final class Fields {
        ...
        public static final String CNPJCPF = "cpfOrCnpj";
    }
    ...
    public CustomerEntity withId(final Integer id) {
        if (id == null || id == 0) {
            this.id = RealmAutoIncrement.autoIncrementor(getClass(), Fields.ID).getNextIdFromModel();
        } else {
            this.id = id;
        }
        return this;
    ...
    public CustomerEntity withIe(final String ie) {
        this.ie = ie;
        return this;
    }
    ...
    public CustomerEntity withBuyer(final String buyer) {
        this.buyer = buyer;
        return this;
    }
    ...
    public CustomerEntity withStatus(@CustomerStatus final Integer status) {
        if (status == null) {
            this.status = CustomerStatus.STATUS_UNMODIFIED;
        } else {
            this.status = status;
        }
        return this;
