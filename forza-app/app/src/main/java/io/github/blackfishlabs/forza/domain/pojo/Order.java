...
import static io.github.blackfishlabs.forza.helper.DateUtils.getCurrentDateTimeInMillis;
import static io.github.blackfishlabs.forza.helper.FormattingUtils.formatAsISODateTime;
import static io.github.blackfishlabs.forza.helper.NumberUtils.withDefaultValue;
...
public class Order {
    ...
    public OrderDto createPostOrder() {
        ...
        String chargeCode = PresentationInjector.provideSettingsRepository().getSettings().getChargeCode();
